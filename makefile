...
export SOURCE_FILES := $(wildcard main.cpp)
export OBJ_FILES := $(patsubst main.cpp, main.o, $(SOURCE_FILES))
export DEP_FILES := $(patsubst main.cpp, main.dep, $(SOURCE_FILES))
export COV_FILES := $(patsubst main.cpp, main, $(SOURCE_FILES))
...
$(EXECUTABLE) : $(OBJ_FILES)
	...
	@gcc --std=c++2a test.cpp  /usr/lib/gcc/x86_64-linux-gnu/9/libstdc++.a -o test

%.o:
	@echo "Compiling $<"
	@gcc --std=c++2a $(DEBUG_FLAGS) -c $< -o $@
